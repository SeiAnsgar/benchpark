...
#class has to be named according to its folder-name
#per node: 2xcpu @52 cores =104
class ZihBarnard(System):
    ...
    def __init__(self, spec):
        ...
        setattr(self, "sys_cores_per_node", 104)
    ...
    def compute_packages_section(self):
        selections = {
            "packages": {
                ...
                "python": {
                    "externals": [{"spec": "python@3.11.5", "prefix": "/software/rapids/r24.04/Python/3.11.5-GCCcore-13.2.0/"}],
                    "buildable": False,
                },
            }
        }
